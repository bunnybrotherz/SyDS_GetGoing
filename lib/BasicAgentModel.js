...
function renderAgents() {
  ...
  surface.selectAll("line.assignment")
    ...
    .attr("stroke", d => {
      ...
      else return "rgba(255, 159, 64, 0.7)"; // Elderly and Disabled - Orange
    })
...
function updateCounters() {
  ...
  document.getElementById('urgency-stats').innerHTML = `
    ...
    <div class="urgency-progress">
      <div>Medium Priority (Elderly & Disabled): ${savedByUrgency[2]}/${totalByUrgency[2]} (${totalByUrgency[2] > 0 ? Math.round(savedByUrgency[2]/totalByUrgency[2]*100) : 0}%)</div>
      <div class="progress-bar">
...
function showResults() {
  ...
  modalContent.innerHTML = `
    ...
    <div class="stat-box medium-urgency">Disabled: ${results.disabled} (${totalAgentsByType.disabled - results.disabled} perished)</div>
    ...
    <div class="urgency-progress">
      <div>Medium Priority (Elderly & Disabled): ${rescuedByPriority.medium}/${totalByPriority.medium} (${totalByPriority.medium > 0 ? Math.round(rescuedByPriority.medium/totalByPriority.medium*100) : 0}%)</div>
      <div class="progress-bar">
    ...
    <div>Total: ${perished.youth + perished.adult + perished.elderly + perished.disabled + perished.packing + perished.first_aider}</div>
