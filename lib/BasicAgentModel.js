// take note, for elderly+disabled priority: bias set to 55
// for adult+youth priority: bias set to 95
...
var urgencyLevels = {
  youth: 2,    // High urgency
  adult: 2,    // High urgency
  elderly: 1,  // Low urgency (changed from 3 to 2)
  disabled: 1  // Low urgency (changed from 2 to 2)
};
