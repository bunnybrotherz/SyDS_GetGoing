...
function spawnNewHelpers() {
  ...
  if (unassignedVictims.length > 0) {
    ...
    newHelpers.forEach(helper => {
      ...
      // Calculate distances for all remaining unassigned victims
      ...
      console.log(`New ${helper.type} helper spawned and assigned to ${targetVictim.type} victim (distance: ${potentialVictims[0].distance.toFixed(2)})`);
    });
