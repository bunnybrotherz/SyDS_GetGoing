...
function updateCounters() {
  ...
  document.getElementById('youth-count').textContent = `Youth Saved: ${savedCount.youth} (Medium Urgency)`;
  document.getElementById('adult-count').textContent = `Adults Saved: ${savedCount.adult} (Low Urgency)`;
  document.getElementById('elderly-count').textContent = `Elderly Saved: ${savedCount.elderly} (High Urgency)`;
  document.getElementById('disabled-count').textContent = `Disabled Saved: ${savedCount.disabled} (High Urgency)`;
...
function setupCanvas() {
  ...
  counterContainer.innerHTML = `
    ...
    <p id="youth-count">Youth Saved: 0 (Medium Urgency)</p>
    <p id="adult-count">Adults Saved: 0 (Low Urgency)</p>
    <p id="elderly-count">Elderly Saved: 0 (High Urgency)</p>
    <p id="disabled-count">Disabled Saved: 0 (High Urgency)</p>
  ...
  legend.innerHTML = `
    <div style="margin-top: 10px;">
      <span style="background-color: rgba(255, 0, 0, 0.3); padding: 2px 10px; margin-right: 5px;">High Urgency</span>
      <span style="background-color: rgba(255, 165, 0, 0.3); padding: 2px 10px; margin-right: 5px;">Medium Urgency</span>
      <span style="background-color: rgba(0, 128, 0, 0.3); padding: 2px 10px;">Low Urgency</span>
    </div>
  `;
