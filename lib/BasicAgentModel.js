...
function setupCanvas() {
  ...
  victims = generateRandomVictims(100);
  ...
  // Create a slider with 3 fixed values: 0.25, 1, and 4
  const slider = document.createElement("input");
  slider.type = "range";
  slider.min = "0";
  slider.max = "2";
  slider.step = "1";  // Only increments by 1
  slider.value = "1";  // Default value 1x
  slider.id = "slider1";
...
function startSim() {
  ...
  let speedMap = [0.25, 1, 4];  // Corresponding time multipliers for 0.25x, 1x, and 4x speeds
...
function startTimer() {
  const speedMap = [0.25, 1, 4];  // Corresponding time multipliers for 0.25x, 1x, 4x speeds
